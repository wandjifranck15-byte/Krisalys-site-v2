  ...
  return (
    <section className="bg-krisalys-black py-20">
      <Container className="max-w-5xl">
        ...
        <FadeIn>
          <SectionHeading eyebrow="À propos" title="Pourquoi KRISALYS existe" light />
          <p className="mt-6 max-w-3xl text-krisalys-gray-light">
          ...
          <p className="mt-4 max-w-3xl text-krisalys-gray-light">
        ...
        <div className="mt-16 grid gap-10 md:grid-cols-[minmax(0,280px)_1fr] md:items-start">
          <FadeIn delay={0.1}>
            <div className="relative mx-auto aspect-[4/5] w-full max-w-[280px] rounded-2xl border border-krisalys-blue-deep/20 bg-krisalys-charcoal">
              <div className="absolute inset-0 flex items-center justify-center">
                <UserRound className="h-16 w-16 text-krisalys-gray" strokeWidth={1} />
              </div>
              {/* Repères d'angle premium */}
              <div className="absolute left-3 top-3 h-4 w-4 border-l-2 border-t-2 border-krisalys-orange/40" />
              <div className="absolute bottom-3 right-3 h-4 w-4 border-b-2 border-r-2 border-krisalys-orange/40" />
            </div>
            <p className="mx-auto mt-3 max-w-[280px] text-center text-xs text-krisalys-gray">Photo à venir</p>
            <p className="mx-auto mt-1 max-w-[280px] text-center text-xs tracking-widest text-krisalys-gray">
              FONDATEUR — DIRECTION GÉNÉRALE
            </p>
          </FadeIn>

          <FadeIn delay={0.2}>
            <p className="text-krisalys-gray-light">
            ...
            <p className="mt-4 text-krisalys-gray-light">
              Cette approche est portée par <strong className="text-white">Franck Wandji</strong>,
            ...
            <blockquote className="mt-8 border-l-2 border-krisalys-gold/50 pl-5 text-lg italic text-white">
              « La technologie attire le regard. La communication crée la valeur. »
            </blockquote>

            <div className="mt-6 border-t border-white/10 pt-4">
              <p className="font-semibold text-white">Franck Wandji</p>
              <p className="text-sm text-krisalys-gray-light">Fondateur &amp; Directeur Général</p>
              <p className="text-sm text-krisalys-gray">{siteConfig.legalName}</p>
            </div>
          </FadeIn>
        </div>
        ...
        <FadeIn delay={0.1} className="mt-16">
          <h3 className="mb-6 text-sm font-semibold uppercase tracking-widest text-krisalys-orange">
            ...
            {steps.map((step, i) => (
              <div key={step.label} className="flex items-center gap-2">
                <span
                  className={
                    step.active
                      ? "h-2.5 w-2.5 shrink-0 animate-pulse rounded-full bg-krisalys-orange"
                      : "h-2.5 w-2.5 shrink-0 rounded-full bg-krisalys-blue"
                  }
                />
                <span className="text-sm text-krisalys-gray-light">{step.label}</span>
                {i < steps.length - 1 && (
                  <span className="hidden text-krisalys-gray-dark md:mx-2 md:inline">—</span>
                )}
              </div>
            ))}
          </div>
        ...
        <FadeIn delay={0.15} className="mt-16">
          <div className="rounded-2xl border border-white/10 bg-krisalys-anthracite p-6 sm:max-w-sm">
            ...
            <div className="mt-3 space-y-1 text-sm text-krisalys-gray-light">
